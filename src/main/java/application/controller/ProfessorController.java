...
public class ProfessorController implements IProfessorController{
    ...
    public ProfessorController(TextField tfCodigoProfessor, TextField tfNomeProfessor, TextField tdTitulacaoProfessor, TextArea taListaProfessores) {
        this.tfCodigoProfessor = tfCodigoProfessor;
        this.tfNomeProfessor = tfNomeProfessor;
        this.tfTitulacaoProfessor = tdTitulacaoProfessor;
